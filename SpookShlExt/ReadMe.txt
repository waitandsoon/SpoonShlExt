========================================================================
    ACTIVE TEMPLATE LIBRARY : SpookShlExt Project Overview
========================================================================

AppWizard has created this SpookShlExt project for you to use as the starting point for
...
SpookShlExt.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (SpookShlExt.h)
        GUID definitions                                (SpookShlExt_i.c)
        A type library                                  (SpookShlExt.tlb)
        Marshaling code                                 (SpookShlExt_p.c and dlldata.c)

SpookShlExt.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in SpookShlExt.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named SpookShlExt.pch and a precompiled types file named StdAfx.obj.
...
SpookShlExtps.vcxproj
	...
	dlldata.c, SpookShlExt_i.c and SpookShlExt_p.c which are required
	to build the proxy/stub DLL.

SpookShlExtps.vcxproj.filters
